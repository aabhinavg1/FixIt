...
import { Question } from '@site/docs/mcq/Question';
      ...
      {unlocked ? (
        ...
        >
          <div>
            ...
            <h2 style={{marginTop: '0.35rem'}}>20 unique mixed MCQs for this day</h2>
          </div>
          ...
          >
            <p style={{marginTop: 0}}>
              A practical mix for this day is:
            </p>
...
export default function DailyMcqDayFrameV2(props) {
  return (
